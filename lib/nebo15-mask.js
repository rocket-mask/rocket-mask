...
/***/ function(module, exports) {
	...
	var MaskedInput = function (_Mask) {
	  _inherits(MaskedInput, _Mask);
	
	  function MaskedInput(element, mask) {
	    _classCallCheck(this, MaskedInput);
	
	    var _this4 = _possibleConstructorReturn(this, (MaskedInput.__proto__ || Object.getPrototypeOf(MaskedInput)).call(this, mask));
	    ...
	    _this4._element.addEventListener('change', _this4.onInputChange);
	    _this4._element.addEventListener('keydown', _this4.onKeydown);
	    return _this4;
	  }
